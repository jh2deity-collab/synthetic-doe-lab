        ...
        <div style={{
            ...
            <section style={{ marginBottom: '32px' }}>
                ...
                <div style={{
                    ...
                    {chartImage ? (
                        <img src={chartImage} alt="Analysis Chart" style={{ maxWidth: '100%', maxHeight: '400px', objectFit: 'contain' }} />
                    ) : (
                        <div style={{ color: '#9ca3af' }}>Chart Image Not Available</div>
                    )}
                </div>
            </section>
            ...
            <section style={{ marginBottom: '48px' }}>
                ...
                <div style={{
                    ...
                    <strong style={{ color: '#1d4ed8', display: 'block', marginBottom: '8px' }}>Analysis Interpretation:</strong>
                    {insight}
                </div>
            </section>
